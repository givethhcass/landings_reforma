        ...
        <div class="nk-header-content-inner">
            ...
            <div class="col-lg-8 col-md-8">
                   ...
                   <div class="para">
                      ...
                      <h1 class="nk-title display-1 text-white text-center"><span class="text-main">La realidad política <br>de México</span>
                     ...
                     <p class="pcoverlast text-lg-right">Denise Dresser</p>

                   



                   <p class="pcoverbold">Aprende sobre las principales disputas, ideologías, partidos, pensamientos y protagonistas que construyen la realidad política en México.</p>



                   <p class="pcoverslim">Impartido por Denise Dresser, la académica y politóloga más brillante y controvertida de México.</p>



                   <p class="pcoverlast">Duración: 7 capítulos / 12 horas.</p>
...
<div class=""><img class="person" alt="Lorenzo Meyer" src="./assets/images/denisedresser.png"></div>
...
<form method="post" action="https://gateway.payulatam.com/ppp-web-gateway" style="display:none;" name="LM-form">
  ...
    <input name="description" type="hidden" value="Curso Denise Dresser Landing Reforma"/>
