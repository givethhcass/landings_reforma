...
$hash = "LzMHJvcc2Zi2V5XO62EPulyzPR"."~"."576116"."~".$referenceCode."~"."499"."~"."MXN";
...
<script>
    (function(h,o,t,j,a,r){
        ...
        h._hjSettings={hjid:1075245,hjsv:6};
        ...
        <div class="nk-header-content-inner">
            ...
            <div class="col-lg-8 col-md-8">
                   ...
                   <div class="para">
                    ...
                    <h1 class="nk-title display-1 text-white text-center"><span class="text-main"> Los orígenes del méxico contemporáneo</span>
                ...
                <p class="pcoverboldx text-center">-Curso en línea-</p>



                     <p class="pcoverlast text-lg-right">Lorenzo Meyer</p>

                   



                   <p class="pcoverbold">Descubre una mirada distinta sobre los grandes personajes y procesos que han marcado la historia del poder en México, desde la época prehispánica hasta el Porfiriato.</p>



                   <p class="pcoverslim">Impartido por uno de los historiadores y analistas políticos más reconocidos en México.</p>



                   <p class="pcoverlast">Duración: 6 capítulos / 11 horas.</p>
...
<div class=""><img class="person" alt="Lorenzo Meyer" src="./assets/images/lorenzo.png"></div>
...
<form method="post" action="https://gateway.payulatam.com/ppp-web-gateway" style="display:none;" name="LM-form">
  ...
    <input name="description" type="hidden" value="Curso Lorenzo Meyer Landing Reforma"/>
